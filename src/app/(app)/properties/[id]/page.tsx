...
import type { Property, Tenancy, Transaction, Loan, AppDocument, Booking } from '@/types';
...
export default async function PropertyDetailPage({
  ...
  const documentRows = (documents ?? []) as AppDocument[];
  const bookingRows = (bookings ?? []) as Booking[];

  const activeTenancy = tenancyRows.find((t) => t.status === 'active');
